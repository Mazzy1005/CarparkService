...
<ul class="nav nav-pills">
 ...
 <li class="nav-item">
   ...
   <li class="nav-item nav-link">
	...
	<h1>Изменить данные водителя</h1>
	<form method="post">
		<input type="hidden" value="${driver.id}" name="id" />
		<label>Фамилия</label><br>
		<input type="text" name="last_name" value="${driver.lastName}" /><br>
		<br> <label>Имя</label><br>
		<input type="text" name="first_name" value="${driver.firstName}" /><br><br>
		<label>Отчество</label><br>
		<input type="text" name="father_name" value="${driver.fatherName}"><br><br>
